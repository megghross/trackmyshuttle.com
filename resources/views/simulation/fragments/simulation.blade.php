...
<body  data-url="{{route("util.getShuttles")}}" data-baseurl="{{asset("assets/livetracking/")}}" data-locationupdate="{{route("util.updateLocation")}}">
<div class="routes-edit-page-container">
    ...
    <div class="routes-edit-page-container">
        ...
        <div class="mapLeftTop">
            ...
            <div class="location-update-status"> Updating Location!</div>
        </div>
    </div>
...
<script src="{{asset("custom-js/Simulation.js")}}"></script>
