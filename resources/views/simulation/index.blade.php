@extends('layouts.main', ['title'=>'Simulation of Different Scenarios'])
    ...
    <main class="main-wrapper clearfix">
        ...
        <div class="row page-title clearfix">
            <div class="page-title-left">
                <h6 class="page-title-heading mr-0 mr-r-5">{{_("Simulation of Different Scenarios")}}</h6>
            </div><!-- /.page-title-left -->
        ...
        <div class="widget-list">
            <div class="row">
                ...
                <iframe src="{{route("iframe.simulation")}}" width="100%" height="630"></iframe>
