...
<body  data-url="{{route("util.getShuttles")}}" data-baseurl="{{asset("assets/livetracking/")}}"  data-offroute="{{route("util.update")}}">
...
<script src="{{asset("custom-js/Offroute.js")}}"></script>
</body>
</html>
