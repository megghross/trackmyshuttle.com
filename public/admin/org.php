                                ...
                                <div class="row form-row">
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" placeholder="Organization Name"
                                               name="new_org_name" id="new_org_name">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal" id="org_cancel">
                                    Cancel
                                </button>
                            ...
                            <div class="modal-body">
                                <div class="row form-row" id="div_pass_delete">
                                    <div class="input-append col-md-11 col-sm-11 primary">
                                        <input type="input" name="org_to_delete" id="org_to_delete" class="form-control"
                                               placeholder="Enter Organization Name"></div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal" id="delete_cancel">
                                    Cancel
                                </button>
                ...
                <div class="col-md-8">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <div>
                                <button type="button" class="btn btn-white btn-cons" data-toggle="modal"
                                        data-target="#myModal" id="add-org">Add Organization
                                </button>
                                <button type="button" class="btn btn-white" style="margin-bottom: 10px;"
                                        id="refresh-org"><i class="fa fa-refresh"></i></button>
                            </div>
                            ...
                            <form class="form-no-horizontal-spacing" id="form_address">
                                <div class="row column-seperation">
                                    <div class="col-md-12">
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                <input name="org_name" id="org_name" type="text" class="form-control"
                                                       placeholder="Organization Name">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                <input name="org_address" id="org_address" type="text"
                                                       class="form-control" placeholder="Address">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                <input name="org_city" id="org_city" type="text" class="form-control"
                                                       placeholder="City">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-5">
                                                <input name="org_state" id="org_state" type="text" class="form-control"
                                                       placeholder="State">
                                            </div>
                                            <div class="col-md-7">
                                                <input name="org_zip" id="org_zip" type="text" class="form-control"
                                                       placeholder="Postal Code">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                <input name="org_country" id="org_country" type="text"
                                        ...
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                <input name="org_phone" id="org_phone" type="text" class="form-control"
                                        ...
                                        <div class="row form-row">
                                            <div class="col-md-6">
                                                <input name="formLat" id="formLat" type="text" class="form-control"
                                                       placeholder="Latitude">
                                            </div>
                                            <div class="col-md-6">
                                                <input name="formLng" id="formLng" type="text" class="form-control"
                                ...
                                <div class="form-actions">
                                    <div class="pull-right">
                                        ...
                                        <button class="btn btn-primary btn-cons" type="submit"><i class="icon-ok"></i>Apply
                                        </button>
                                    </div>
                                </div>
                            </form>
                            ...
                            <form class="form-no-horizontal-spacing" id="code_generate">
                                <div class="row column-seperation">
                                    <div class="col-md-12">
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                <input name="user_code" id="user_code" type="text"
