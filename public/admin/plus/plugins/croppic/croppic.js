...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			if(that.options.customUploadButtonId ===''){ cropControlUpload = '<i class="cropControlUpload" title="Upload Image"></i>'; }
			var cropControlRemoveCroppedImage = '<i class="cropControlRemoveCroppedImage" title="Remove Image"></i>';
		...
		createCropControls: function(){
			...
			// CREATE CONTROLS
			var cropControlZoomMuchIn =      '<i class="cropControlZoomMuchIn" title="Large Zoom In"></i>';
			var cropControlZoomIn =          '<i class="cropControlZoomIn" title="Zoom In"></i>';
			var cropControlZoomOut =         '<i class="cropControlZoomOut" title="Zoom Out"></i>';
			var cropControlZoomMuchOut =     '<i class="cropControlZoomMuchOut" title="Large Zoom Out"></i>';
			var cropControlCrop =            '<i class="cropControlCrop" title="Crop Image"></i>';
			var cropControlReset =           '<i class="cropControlReset" title="Reset"></i>';
			...
			$.ajax({
                ...
                type: 'POST'
					...
					if(response.status=='success'){
						...
						if(response.mode=="profile"){$(".profile_img").attr("src",response.url);}
						else if(response.mode=="cover"){$("#cover_img").attr("src",response.url);}
