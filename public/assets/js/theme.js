...
function increateval1() {
    ...
    instance1.css('margin-left', '-99px');
    instance1.css('margin-top', '12px');
    instance1.css('font-size', '12px');
}

function increateval2() {
    var val = parseInt(instance2.val());
    val = val + num2;
    instance2.val(val).trigger('change');
    if (val >= 75) {
        instance2.trigger('configure', { "fgColor": light_blue });
        instance2.css({ color: light_blue });
        instance2.parent().parent().parent().children().eq(1).css({ color: light_blue });
    } else if (val >= 50) {
        instance2.trigger('configure', { "fgColor": "orange" });
        instance2.css({ color: 'orange' });
        instance2.parent().parent().parent().children().eq(1).css({ color: 'orange' });
    } else {
        instance2.trigger('configure', { "fgColor": light_red });
        instance2.css({ color: light_red });
        instance2.parent().parent().parent().children().eq(1).css({ color: light_red });
    }
    if (val == 100 || val == 0)
        clearInterval(interval2);
    instance2.css('margin-left', '-99px');
    instance2.css('margin-top', '12px');
    instance2.css('font-size', '12px');
}

function increateval3() {
    var val = parseInt(instance3.val());
    val = val + num3;
    instance3.val(val).trigger('change');
    if (val >= 75) {
        instance3.trigger('configure', { "fgColor": light_blue });
        instance3.css({ color: light_blue });
        instance3.parent().parent().parent().children().eq(1).css({ color: light_blue });
    } else if (val >= 50) {
        instance3.trigger('configure', { "fgColor": "orange" });
        instance3.css({ color: 'orange' });
        instance3.parent().parent().parent().children().eq(1).css({ color: 'orange' });
    } else {
        instance3.trigger('configure', { "fgColor": light_red });
        instance3.css({ color: light_red });
        instance3.parent().parent().parent().children().eq(1).css({ color: light_red });
    }
    if (val == 100 || val == 0)
        clearInterval(interval3);
    instance3.css('margin-left', '-99px');
    instance3.css('margin-top', '12px');
    instance3.css('font-size', '12px');
}

function increateval4() {
    var val = parseInt(instance4.val());
    val = val + num4;
    instance4.val(val).trigger('change');
    if (val >= 75) {
        instance4.trigger('configure', { "fgColor": light_blue });
        instance4.css({ color: light_blue });
        instance4.parent().parent().parent().children().eq(1).css({ color: light_blue });
    } else if (val >= 50) {
        instance4.trigger('configure', { "fgColor": "orange" });
        instance4.css({ color: 'orange' });
        instance4.parent().parent().parent().children().eq(1).css({ color: 'orange' });
    } else {
        instance4.trigger('configure', { "fgColor": light_red });
        instance4.css({ color: light_red });
        instance4.parent().parent().parent().children().eq(1).css({ color: light_red });
    }
    if (val == 100 || val == 0)
        clearInterval(interval4);
    instance4.css('margin-left', '-99px');
    instance4.css('margin-top', '12px');
    instance4.css('font-size', '12px');
}

function increateval5() {
    var val = parseInt(instance5.val());
    val = val + num5;
    instance5.val(val).trigger('change');
    if (val >= 75) {
        instance5.trigger('configure', { "fgColor": light_blue });
        instance5.css({ color: light_blue });
        instance5.parent().parent().parent().children().eq(1).css({ color: light_blue });
    } else if (val >= 50) {
        instance5.trigger('configure', { "fgColor": "orange" });
        instance5.css({ color: 'orange' });
        instance5.parent().parent().parent().children().eq(1).css({ color: 'orange' });
    } else {
        instance5.trigger('configure', { "fgColor": light_red });
        instance5.css({ color: light_red });
        instance5.parent().parent().parent().children().eq(1).css({ color: light_red });
    }
    if (val == 100 || val == 0)
        clearInterval(interval5);
    instance5.css('margin-left', '-99px');
    instance5.css('margin-top', '12px');
    instance5.css('font-size', '12px');
}
...
$(document).ready(function() {
    ...
    $(".plugin").click(function() {
        var str = $(this).children().eq(0).children().eq(0).html();
        if (str == 'CONNECTED') {
            $(this).children().eq(0).css('border-color', red);
            $(this).children().eq(0).children().eq(0).css('color', red);
            $(this).children().eq(0).children().eq(0).html('NOT CONNECTED');
            $(this).children().eq(1).css('border-color', red);
            $(this).children().eq(1).children().eq(0).css('color', red);
            $(this).next().html("Plugin tracking device into the shuttle's OBDII Port. Can't find OBDII Port?");
            var ss = $(this).parent().children().eq(1).val();
            ...
            ss = '#' + ss;
            $(ss).children().eq(0).children().eq(0).children().eq(0).children().eq(0).removeClass('fa-check-circle');
            $(ss).children().eq(0).children().eq(0).children().eq(0).children().eq(0).addClass('fa-circle');

            if (ff == '1') {
                instance1 = $('#aaa1 .dial');
                if (interval1 != null)
                    clearInterval(interval1);
                interval1 = setInterval(increateval1, 50);
                instance1.val(100).trigger('change');
                num1 = -1;
            } else if (ff == '2') {
                instance2 = $('#aaa2 .dial');
                if (interval2 != null)
                    clearInterval(interval2);
                interval2 = setInterval(increateval2, 50);
                instance2.val(100).trigger('change');
                num2 = -1;
            } else {
                instance3 = $('#aaa3 .dial');
                if (interval3 != null)
                    clearInterval(interval3);
                interval3 = setInterval(increateval3, 50);
                instance3.val(100).trigger('change');
                num3 = -1;
            }
            var temp = '#track' + ff + ' .inside';
            $(temp).css('width', '96%');
            ...
            $(this).children().eq(0).css('border-color', light_blue);
            $(this).children().eq(0).children().eq(0).css('color', light_blue);
            $(this).children().eq(0).children().eq(0).html('CONNECTED');
            $(this).children().eq(1).css('border-color', light_blue);
            $(this).children().eq(1).children().eq(0).css('color', light_blue);
            $(this).next().html("Congratulations!You've just completed the hardest task.");
            var ss = $(this).parent().children().eq(1).val();
            ...
            ss = '#' + ss;
            $(ss).children().eq(0).children().eq(0).children().eq(0).children().eq(0).removeClass('fa-circle');
            $(ss).children().eq(0).children().eq(0).children().eq(0).children().eq(0).addClass('fa-check-circle');

            if (ff == '1') {
                instance1 = $('#aaa1 .dial');
                if (interval1 != null)
                    clearInterval(interval1);
                interval1 = setInterval(increateval1, 25);
                instance1.val(0).trigger('change');
                num1 = 1;
            } else if (ff == '2') {
                instance2 = $('#aaa2 .dial');
                if (interval2 != null)
                    clearInterval(interval2);
                interval2 = setInterval(increateval2, 50);
                instance2.val(0).trigger('change');
                num2 = 1;
            } else if (ff == '3') {
                instance3 = $('#aaa3 .dial');
                if (interval3 != null)
                    clearInterval(interval3);
                interval3 = setInterval(increateval3, 50);
                instance3.val(0).trigger('change');
                num3 = 1;
            } else if (ff == '4') {
                instance4 = $('#aaa4 .dial');
                if (interval4 != null)
                    clearInterval(interval4);
                interval4 = setInterval(increateval4, 50);
                instance4.val(0).trigger('change');
                num4 = 1;
            } else {
                instance5 = $('#aaa5 .dial');
                if (interval5 != null)
                    clearInterval(interval5);
                interval5 = setInterval(increateval5, 50);
                instance5.val(0).trigger('change');
                num5 = 1;
            }
            var temp = '#track' + ff + ' .inside';
            $(temp).css('width', '0%');
    ...
    //end of click devices


    $("#aaa1").mousemove(function() {
        var d = $("#aaa1 .dial");
        var va = parseInt(d.val());
        $("#aaa1 .dial-percent").val(va + '%'); //by yuriy
        if (va >= 75) {
            d.trigger('configure', { "fgColor": light_blue });
            d.css({ color: light_blue });
            $("#aaa1").parent().children().eq(1).css({ color: light_blue });
            $("#aaa1 .dial-percent").css('color', light_blue); //by yuriy
        } else if (va >= 50) {
            d.trigger('configure', { "fgColor": "orange" });
            d.css({ color: 'orange' });
            $("#aaa1 .dial-percent").css('color', 'orange'); //by yuriy
            $("#aaa1").parent().children().eq(1).css({ color: 'orange' });
        } else {
            d.trigger('configure', { "fgColor": light_red });
            $("#aaa1").parent().children().eq(1).css({ color: light_red });
            d.css({ color: light_red });
            $("#aaa1 .dial-percent").css('color', light_red); //by yuriy
        }
        $("#aaa1 .dial").css('margin-left', '-99px');
        $("#aaa1 .dial").css('margin-top', '12px');
        $("#aaa1 .dial").css('font-size', '12px');

    });

    $("#aaa2").mousemove(function() {
        var d = $("#aaa2 .dial");
        var va = parseInt(d.val());
        $("#aaa2 .dial-percent").val(va + '%'); //by yuriy
        if (va >= 75) {
            d.trigger('configure', { "fgColor": light_blue });
            d.css({ color: light_blue });
            $("#aaa2").parent().children().eq(1).css({ color: light_blue });
            $("#aaa2 .dial-percent").css('color', light_blue); //by yuriy
        } else if (va >= 50) {
            d.trigger('configure', { "fgColor": "orange" });
            d.css({ color: 'orange' });
            $("#aaa2 .dial-percent").css('color', 'orange'); //by yuriy
            $("#aaa2").parent().children().eq(1).css({ color: 'orange' });
        } else {
            d.trigger('configure', { "fgColor": light_red });
            $("#aaa2").parent().children().eq(1).css({ color: light_red });
            d.css({ color: light_red });
            $("#aaa2 .dial-percent").css('color', light_red); //by yuriy
        }
        $("#aaa2 .dial").css('margin-left', '-99px');
        $("#aaa2 .dial").css('margin-top', '12px');
        $("#aaa2 .dial").css('font-size', '12px');

    });

    $("#aaa3").mousemove(function() {
        var d = $("#aaa3 .dial");
        var va = parseInt(d.val());
        $("#aaa3 .dial-percent").val(va + '%'); //by yuriy
        if (va >= 75) {
            d.trigger('configure', { "fgColor": light_blue });
            d.css({ color: light_blue });
            $("#aaa3").parent().children().eq(1).css({ color: light_blue });
            $("#aaa3 .dial-percent").css('color', light_blue); //by yuriy
        } else if (va >= 50) {
            d.trigger('configure', { "fgColor": "orange" });
            d.css({ color: 'orange' });
            $("#aaa3 .dial-percent").css('color', 'orange'); //by yuriy
            $("#aaa3").parent().children().eq(1).css({ color: 'orange' });
        } else {
            d.trigger('configure', { "fgColor": light_red });
            $("#aaa3").parent().children().eq(1).css({ color: light_red });
            d.css({ color: light_red });
            $("#aaa3 .dial-percent").css('color', light_red); //by yuriy
        }
        $("#aaa3 .dial").css('margin-left', '-99px');
        $("#aaa3 .dial").css('margin-top', '12px');
        $("#aaa3 .dial").css('font-size', '12px');

    });

    $("#aaa4").mousemove(function() {
        var d = $("#aaa4 .dial");
        var va = parseInt(d.val());
        $("#aaa4 .dial-percent").val(va + '%'); //by yuriy
        if (va >= 75) {
            d.trigger('configure', { "fgColor": light_blue });
            d.css({ color: light_blue });
            $("#aaa4").parent().children().eq(1).css({ color: light_blue });
            $("#aaa4 .dial-percent").css('color', light_blue); //by yuriy
        } else if (va >= 50) {
            d.trigger('configure', { "fgColor": "orange" });
            d.css({ color: 'orange' });
            $("#aaa4 .dial-percent").css('color', 'orange'); //by yuriy
            $("#aaa4").parent().children().eq(1).css({ color: 'orange' });
        } else {
            d.trigger('configure', { "fgColor": light_red });
            $("#aaa4").parent().children().eq(1).css({ color: light_red });
            d.css({ color: light_red });
            $("#aaa4 .dial-percent").css('color', light_red); //by yuriy
        }
        $("#aaa4 .dial").css('margin-left', '-99px');
        $("#aaa4 .dial").css('margin-top', '12px');
        $("#aaa4 .dial").css('font-size', '12px');

    });

    $("#aaa5").mousemove(function() {
        var d = $("#aaa5 .dial");
        var va = parseInt(d.val());
        $("#aaa5 .dial-percent").val(va + '%'); //by yuriy
        if (va >= 75) {
            d.trigger('configure', { "fgColor": light_blue });
            d.css({ color: light_blue });
            $("#aaa5").parent().children().eq(1).css({ color: light_blue });
            $("#aaa5 .dial-percent").css('color', light_blue); //by yuriy
        } else if (va >= 50) {
            d.trigger('configure', { "fgColor": "orange" });
            d.css({ color: 'orange' });
            $("#aaa5 .dial-percent").css('color', 'orange'); //by yuriy
            $("#aaa5").parent().children().eq(1).css({ color: 'orange' });
        } else {
            d.trigger('configure', { "fgColor": light_red });
            $("#aaa5").parent().children().eq(1).css({ color: light_red });
            d.css({ color: light_red });
            $("#aaa5 .dial-percent").css('color', light_red); //by yuriy
        }
        $("#aaa5 .dial").css('margin-left', '-99px');
        $("#aaa5 .dial").css('margin-top', '12px');
        $("#aaa5 .dial").css('font-size', '12px');

    });

    $("#aaa1").empty();
    $('#aaa1').append($('<input type="text" value="100" class="dial"/> '));
    $('#aaa1').append($('<input type="text" value="100%" class="dial-percent"/> ')); //by yuriy
    $("#aaa1 .dial").knob({
        min: 0,
        max: 100,
        step: 1,
    ...
    $("#aaa1 .dial").css('margin-left', '-99px');
    $("#aaa1 .dial").css('margin-top', '12px');
    $("#aaa1 .dial").css('font-size', '14px');
    $("#aaa1 canvas").css("border-radius", "50%");
    $("#aaa1 canvas").css("border-style", "solid");
    $("#aaa1 canvas").css("border-width", "3px");
    $("#aaa1 canvas").css("border-color", "transparent");
    $("#aaa1 canvas").css("display", "line-block");
    $("#aaa1 canvas").css("background-color", "#eeeeee");
    $("#aaa1 canvas").css("width", "100px");
    $("#aaa1 canvas").css("height", "100px");

    $("#aaa2").empty();
    $('#aaa2').append($('<input type="text" value="100" class="dial"/> '));
    $('#aaa2').append($('<input type="text" value="100%" class="dial-percent"/> ')); //by yuriy
    $("#aaa2 .dial").knob({
        min: 0,
        max: 100,
        step: 1,
    ...
    $("#aaa2 .dial").css('margin-left', '-99px');
    $("#aaa2 .dial").css('margin-top', '12px');
    $("#aaa2 .dial").css('font-size', '14px');
    $("#aaa2 canvas").css("border-radius", "50%");
    $("#aaa2 canvas").css("border-style", "solid");
    $("#aaa2 canvas").css("border-width", "3px");
    $("#aaa2 canvas").css("border-color", "transparent");
    $("#aaa2 canvas").css("display", "line-block");
    $("#aaa2 canvas").css("background-color", "#eeeeee");
    $("#aaa2 canvas").css("width", "100px");
    $("#aaa2 canvas").css("height", "100px");

    $("#aaa3").empty();
    $('#aaa3').append($('<input type="text" value="100" class="dial"/> '));
    $('#aaa3').append($('<input type="text" value="100%" class="dial-percent"/> ')); //by yuriy
    $("#aaa3 .dial").knob({
        min: 0,
        max: 100,
        step: 1,
    ...
    $("#aaa3 .dial").css('margin-left', '-99px');
    $("#aaa3 .dial").css('margin-top', '12px');
    $("#aaa3 .dial").css('font-size', '14px');
    $("#aaa3 canvas").css("border-radius", "50%");
    $("#aaa3 canvas").css("border-style", "solid");
    $("#aaa3 canvas").css("border-width", "3px");
    $("#aaa3 canvas").css("border-color", "transparent");
    $("#aaa3 canvas").css("display", "line-block");
    $("#aaa3 canvas").css("background-color", "#eeeeee");
    $("#aaa3 canvas").css("width", "100px");
    $("#aaa3 canvas").css("height", "100px");

    $("#aaa4").empty();
    $('#aaa4').append($('<input type="text" value="100" class="dial"/> '));
    $('#aaa4').append($('<input type="text" value="100%" class="dial-percent"/> ')); //by yuriy
    $("#aaa4 .dial").knob({
        min: 0,
        max: 100,
        step: 1,
    ...
    $("#aaa4 .dial").css('margin-left', '-99px');
    $("#aaa4 .dial").css('margin-top', '12px');
    $("#aaa4 .dial").css('font-size', '14px');
    $("#aaa4 canvas").css("border-radius", "50%");
    $("#aaa4 canvas").css("border-style", "solid");
    $("#aaa4 canvas").css("border-width", "3px");
    $("#aaa4 canvas").css("border-color", "transparent");
    $("#aaa4 canvas").css("display", "line-block");
    $("#aaa4 canvas").css("background-color", "#eeeeee");
    $("#aaa4 canvas").css("width", "100px");
    $("#aaa4 canvas").css("height", "100px");

    $("#aaa5").empty();
    $('#aaa5').append($('<input type="text" value="100" class="dial"/> '));
    $('#aaa5').append($('<input type="text" value="100%" class="dial-percent"/> ')); //by yuriy
    $("#aaa5 .dial").knob({
        min: 0,
        max: 100,
        step: 1,
    ...
    $("#aaa5 .dial").css('margin-left', '-99px');
    $("#aaa5 .dial").css('margin-top', '12px');
    $("#aaa5 .dial").css('font-size', '14px');
    $("#aaa5 canvas").css("border-radius", "50%");
    $("#aaa5 canvas").css("border-style", "solid");
    $("#aaa5 canvas").css("border-width", "3px");
    $("#aaa5 canvas").css("border-color", "transparent");
    $("#aaa5 canvas").css("display", "line-block");
    $("#aaa5 canvas").css("background-color", "#eeeeee");
    $("#aaa5 canvas").css("width", "100px");
    $("#aaa5 canvas").css("height", "100px");
            ...
            el.each(function() {
                ...
                if ($this.data('type') !== undefined) {
                    ...
                    switch ($this.data('type')) {
                        case 'success':
                            options.confirmButtonClass = 'btn btn-success';
                            break;
                        case 'warning':
                            options.confirmButtonClass = 'btn btn-warning';
                            break;
                        case 'error':
